...
Klantenrotatie ($\sim \fraq{1}{\text{klantenkrediet}}$) willen we zo groot mogelijk hebben (dan betalen ze sneller), leveranciersrotatie willen we zo laag mogelijk (later leveranciers betalen). 
