...
Slide 1: Bain $\&$ company: strategie consulting firma: bedrijf dat CEO's helpt, ze helpen bedrijfsleiders met dat soort vragen waarvan ze 's nachts wakker liggen. Bain helpt hierbij. Zaken die het verschil maken tussen succes en geen succes zijn het type vragen dat Bain wil beantwoorden. 
Slide 2: Wat zijn de verschillende footprintvragen? We gaan enkele vbn zien van wat dat allemaal kan zijn.
Do's $\&$ don't's: zaken die belangrijk zijn omtrent footprint. 
Uitgebreid vb van een project dat 10j geleden gebeurd is.

Footprint: bedrijven die typisch fabrieken hebben op verschillende locaties en waar de vraag is "staan ze op de juiste plaats, hebben wehe tjuiste aantal, waar ze nu staan, si dat de meest economische manier van werken?" dit is belangrijk: 75% vna de bedrijfsleiders is niet tevreden met hun footprint. De belangrijkste reden is dat het veranderen van footprint (Dus bv fabrieken verhuizen) niet gemakkelijk is. Veel bedrijven zijn dus niet gelukkig met hun footprint maar doen er niks aan. Het is ook erg duur om te veranderen van footprint: heel veel te maken met de sociale impact: als je een fabriek moet sluiten en mense moet ontslaan, is dat erg duur (als je die fabriek echt nodig hebt). Het is belangrijk, meestal niet supergoed, maar we kunnen er toch niet zoveel aan doen.
Bain probeert te helpen als het niet goed is, om een manier te zoeken om in de juiste richitng te gaan. Het is nooit makkelijk, maar er is dikwijls een goeie rationale om het te doen om een waardige manier.
Vbn van footprint zijn meestal heel negatief. Ford Genk bv. Als footprintvragen in het nieuws komen, is dat meestal heel negatief omdat het gaat over productie die geslotenw ordt, verhuist naar Azie,… Dit hoeft niet altijd zo te zijn! --> In de US een omgekeerde beweging: grote beweging waarbij fabrieken uit lageloonlanden naar de US verhuisd zijn. Dit komt omdat transport uit China heel duur is, maar een andere reden die heel veel doorslag gegeven heeft is de lage kost van energie: erg veel gasbronnen bijgekomen. Bij hen is de energieprijs een lange tijd geleden goedkoper geworden, dus het was dikwijls hgoedkoper om dingen te maken in de US, ondanks dat mensen duurder zijn in de US, maar qua energie is het enorm veel goedkoper.
Footprint is dus niet per se negatief!
Slide 12: Vaak zeggen leiders dat het niet goed is en gaat men kijke naar alternatieven, daarbij denk je na over 3 verschillende dingen:
	• Financieën: het gemakkelijke, waar iedereen meteen aan denkt. Het goedkoper maken is dikwijls een drijfveer --> hoeveel beter kan het worden? Even belangrijk is hoeveel het kost om daar te geraken. Dit stuk wordt typisch heel goed bekeken.
	• Strategie: wordt dikwijls veel minder bekeken. Soms moet je iets gewoon doen om te overleven. Het is belangrijk te begrijpen waar uw business naartoe gaat. Het volgen van uw strategie, klanten, leveranciers is heel belangrijk! 
	• Operational targets: operationele realiteit:je kan zeggen dat je uw fabriek in China wilt zetten omdat het daar goedkoper is etc. dit is niet altijd de beste manier. Als je uw fabriek op 6 weken hebt staan van waar uw klanten zijn, zal je ofwel veel stock moeten hebben, ofwel een slechte service bieden aan uw klanten. Het brengt ook een enorme complexiteit mee om uw fabriek in Azie te hebben. Er zijn altijd orders die iets sneller door het systeem moeten,… het moet in lijn zijn met wat uw klanten wensen. 
Slide 13: Wat zijn de groe types van footprintvraagstukken? Typisch 4 grote groepen:
	• Consolidatie: "ik heb een aantal fabrieken en ga het met minder doen" het kan zijn dat je 4 fabrieken hebt die allemaal iets te klein zijn, dus je gaat er 1 van maken. Je gaat het dus met minder doen.
Ecoform (of zoiets): dit bedrijf was gegroeid dor ieder jaar kleine bedrijven bij te kopen. Ieder bedrijfje had zijn eigen fabriekjes. Ze hadden in Europa alleen al 25 kleine fabrieken staan, wereldwijd een 50-tal. Op een zeker moment werd dit te veel (ze maakten hetzelfde) --> consolideren? 
	• Specialisatie: "ik zit met vereschillende fabrieken die ieder toch een beetje hetzelfde doen? Is er een manier om ervoor te zorgen dat ipv ieer van de fabrieken ongeveer hetzelfde doet, elke fabriek specialiseert?" Je kan specialisatie ook doen buiten productspecialisatie: bv rnd complexieit van uw portefeuille. Stel, je maakt verf en je hebt witte verf. Deze is 50% van uw productie. Daar is heel veel concurrentie, de kost is hier oneindig belangrijk. Je maakt ook gouden verf en groene en nog heel veel verschillende kleuren. Kost is hier relatief minder belangrijk,w atn mensen gaan hier heel specifiek kijken.als je dat maakt, moet je de capaciteit hebben om heel snel te wisselen: je moet uw machines kuisen,… --> specialiseer fabrieken in hoge volumes, efficient en low-cost. Aan de andere. Kant heb je een fabriek met veel flexibiliteit .Bv Arista: industriele bakkerij op Europese schaal. Ze maken brood, pizzabodems, pittabroodjes,… --> ze hebben de keuze gemaakt om enerzijds fabrieken open te houden die grote volumes maken van hetzelfde product en aan de andere kant fabrieken die flexibeler moesten zijn: combinate van product $\&$ volume.
	• Migratie: naar lagekostlanden: het is er goedkoper, maar je moet ook letten op al de rest. Bv: kraanfabriek: de kraantjes werden in Duitsland gemaakt. De productie hiervan was redelijk manueel, extreem arbeidsintensief. De consultants die voor dit bedrijf werkten, vonden at het goedkoper zou izjn om het in Vietnam te laten maken. Na een jaar of 2, 3 in Vietnam, kwam de eigenaar terug naar Bain: de hele move was gedaan, de productiekosten gingen naar beneden gaan, maar er werd minder winst gemaakt dan ervoor. Wat was er gebeurd: de kost om het bproduct te maken was behoorlijk gezakt. De logistieke kosten waren echter ontploft. Ze hadden voorzien dat je containers moest aanbrengen vanuit Vietnam, maar ze hadden niet meegerekend dat het 6 weken getransporteerd moest worden op een boot. Het kon 2 tot 2,5 maand duren tot de nood van het product tot het verkrijgen van het product --> heel veen rush orders (op vliegtuig), dit is duurder dan met de boot. Hun warehouse was ook onploft: normaal hadden ze 25 dagen stock nodig om vanuit Duitsland de rest van Europa te dienen. Sinds hun verhuis naar Vietnam, was de size veel groter van het warehouse. Ook waren de klanten niet tevreden. Men is dus gaan opsplitsen tussen grotevolumeproducten, die liet men nog steeds maken in Vietnam, maar de meer speciale producten werden opnieuw in Duitsland gemaakt, maar met automatisatie (geen manuele arbeid meer). Je moet dus altijd opletten met uw footprint!
	• Extension: een bedrijf groeit en heeft meer productie nodig: waar? Geen makkelijke vraag. vb1: Animal hygiene-bedrijf: ontsmettingsmiddelen voor in de veeindustrie, bv melk: die koeien moeten ontsmet worden. Een stuk van die business is aan het verhuizen buiten Europa en ze beginnen nu veel meer te verkopen in Latijns-Amerika. Dat product is op zich niet duur. Een nieuwe fabriek beginnen in Latijns-Amerika is moeilijk, maar containers vol water (en een beetje ontsmettingsmiddelen) de oceaan oversturen, is ook duur. --> what to do? vb2: Mars: voor hun pet food fabrieken was de vraag in de UK aan het stijgen --> nieuwe fabriek daar --> waarom niet in West-Europa? De grondstoffen zijn daar goedkoper, transport naar de Ukwas wel een probleem. 
De manier om deze vragen op te lossen is altijd ongeveer hetzelfde. 
Slide 18: Scenario's gaan afwegen tov elkaar. Het gaat niet enkel om het financiele. Dan maak je een keuze en kan je die implementeren. Als het over niet te complexe vragen gaat, dan mag je makkelijk rekenen op een half jaar tot je een beslissing neemt en het implementeren kan anderhalf tot twee jaar duren. Er is ook de sociale impact. 
Slide 19: Dingen waarover je moet nadenken als je die dingen oplost.
Slide 20: Aantal dingen waaraan je moet denken om ze in rekening te brengen. 
	1. Kost en prijs: heel belangrijk punt.  Zie slide 21.
	2. Wat als inputs/gegevens gebruiken? Zie slide 24
	3. Hoe organiseren? Zie slide 28
	4. Continuous improvement: zie slide 31
Slide 21: Je hebt een fabriek en je maakt iets, bv ammoniak. Als je die in 1 fabriek maakt, kost dat 10 en in een andere fabriek 12,… de curve getoond is daar een vb van: fabriek A is de goedkoopste, dan B,… op een gegeven moment heb je een bepaalde vraag vanuit te markt. --> vraag en aanbod. De prijs in de markt is die van de hoogste in die ranking. In dit geval zal die net iets boven die van Player 1, Plant C zijn. Iedereen die duurder is, zal het moeilijk hebben. Als j ebegint te denken aan fotprint, moet je ook kijken wat er gebeurt met de prijzen in de markt. 2 vbn.
Slide 22: 4 spelers in de markt, wij zijn de blauwe en willen iets doen: we gaan verdwijnen. Wat je ziet is dat de blauwe balk weggaat en de andere spelers die beter zijn gaan die capaciteit opnemen, maar niet helemaal. De prijzen in de markt gaan beginnen stijgen omdat er spelers zijn die duurder zijn, maar hun vraag is opeens teru nodig. Dit is dus belangrijk als jij een speler bent in de markt: als jij de eerste 4 fabrieken hebt en die draaien allemaal aan 80%, dan kan je de laatste wegdoen. De prijzen in de markt gaan stijgen en de eerste drie fabrieken gaan meer winst maken.
Ander vb: je bent de slechtste in de markt, als je uw prijzen gaat verlagen, ga je meer winst maken, tenzij je dat niet genoeg doet (denk ik) --> iedereen zal gewoon minder winst maken. Het risico is dat de enige die voordeel heeft, uw klanten zijn. 
Voorbeeld niet in de slides, zie foto. Je hebt een aantal fabrieken in de US en Europa en ook in Azie. De klant wil de rode bars: in de US zit men aan de goede kant van de lijn (iet de duurste), in Europa zijn ze de goedkoopste en in Azie ook, maar dan besefte men dat het product best wel makkelijk verhuist: de chinezen zouden makkelijk producten kunnen verkopen in Europa. Dan zie je dat het eigenlijk niet zo voordelig is in Europa. Als je weet hoe duur de concurrent kan leveren, weet je hoe jij moet prijzen om te zrogen dat jij verkoopt en niet de concurrent.
Slide 31: Je moet proberen kijken wat gaat werken voor de komende zoveel jaar. 
Slide 32: Gele lijn: jaar na jaar doet die -10%. Plant 2 heeft bv -11% gedaan. Als je wil kijken welke deb este is, moet je ook kijken naar de toekomst.
Slide 24: Wat niet werkt: gut feeling (ik denk, ik voel,…). Niet goed om op basis hiervan beslissingen te nemen. Soms neemt men beslissingen om geen beslissingen te hoeven nemen. Er zijn een hoop vaste kosten en wat je dan dikwijls ziet is dat men iets anders gaat bijsteken in een fabriek zodat je meer volume produceert daar. Je gaat een bepaalde fabriek helpen. Aan de andere kant zal een andere fabriek minder volume hebben en die kan van heel goed naar gewoon goed gaan en een van heel slecht naar ok. 
Bv: in Oostenrijk een klein bedrijfje met 2 productielijnen, wat veel te weinig was (echte goeie fabrieken: 15 lijnen). Men wou de fabriek niet toedoen, dus heeft men een lijn bijgestoken. 5j later ging het weer niet goed, want de 3 lijnen draaiden maar half. Het werd alleen maar moeilijker om de juiste beslissing te nemen (nl ze eruit te halen). 
Heel belangrijk is dus dat je dat soort zaken met de realiteit bekijkt: als het niet goed is, moet je ook kunnen ingrijpen. Je moet ook rekening houden met alles, kijk niet enkel naar uw productiekost, maar ook naar uw logistieke kost. Hoe goedkoper uw product isd at je maakt, hoe relatief belangrijker uw transportkosten worden.
Je moet ook rekening houden met andere kosten: kost om de verandering te doen. Een fabriek sluiten is, zeker in WE, zeer duur. Heel opmerkelijk is dat je heel snel voelt wat een bedrijf zelf wilt. Je moet wel effectief, neutraal gaan bekijken.
Slide 25: Ook belangrijk is om te denken aan capaciteit: je weet dat uw fabriek jaar na jaar meet gaat kunnen maken (capaciteit). Aan de andere kant heb je de vraag, daarvan kan je niet voorspellen wat die gaat zijn. Uw vraag gaat tussen hoog $\&$ laag zitten. Obv daarvan ga je gaan plannen (meer in het weekend werken, volgens een ander patroon,…) --> zien hoe je u gaat aanpassen en dat voor alle fabrieken. Heel belangrijk is ook dat men soms maar een stuk van een fabriek wil wegdoen (een lijn).
Slide 26: Links: kost van de fabriek zoals ze nu is. Structuurkost en dan 2 lijnen, met vaste kosten en variabele kosten. Als je daar 1 lijn uithaalt en de plant cost is oorspronkelijk 30% van uw totaal, om de echte kost te hebben, moet je de kost van heel uw fabriek hebben. Als je nu 1 lijn weghaalt, heeft dat als gevolg dat uw totale plant costs dezelfde blijven. Opeens gaat dat gaan naar 40%: de producten die jverkoopt ga je duurder meoten maken omdat je uw lijn ergens anders hebt gezet. Je moet ook kijken naar de producten die overblijven. 
Slide 28: Je moet heel goed weten wat de mogelijkheden zijn van uw bedrijf. Voor sommige bedrijven is cash het belangrijkste: daarmee zoveel mogelijk bedrijven kopen en verbteren. Wat als je een invetsering moet doen van 100 miljoen en het lever u 20miljoen per jaar op, gaat het wel 5j duren eer je dat teruggewonnen hebt.
Slide 29: Voorbeeld: naar boven: positieve kanten van de footprint: eerste jaar brengt het niet veel op, het volgend jaar wel. Maar je had wel nieuwe capex nodig en kostne om een fabriek toe te doen en een lease opzeggen. Als je dat allemaal in het eerste jaar zou doen, ga je 60 miljoen moeten uitgeven en het levert at best 10 miljoen op. je kan zeggen dat je uw lease pas binnen 2j gaat opzeggen: een miljoen extra betalen, maar wel 40 mil etra winst maken. Plant closure: een jaar uitstellen.
Belangrijk is om het totale plaatje te hebben: logistieke kosten en niet enkel nu, maar ook in de toekomst, niet enkel van 1 product, maar van alle producten. De hoofdboodschap is dat het een complexe oefening is waarbij je moet nadeken wat er allemaal beinvloed wordt. Heel dikwijls heeft men gemerkt dat als je een paar topics vergeet, uw antwoord totaal anders kan zijn. 
Filmpje: Bain heeft samen met AB Inbev een business game gedaan rond MNA in de bio-ingenieursdinges. De uitkomst ervan is dat AB Inbev heeft beslist om de grootste concurrent te kopen. Men gaat dit jaar weer een business game doen. 
Slide 33: Voorbeeld: Balta: een van de grootste producenten van tapijt. Zie extra slides. In 2005 was heel de productie hier in Belgie. De hele streek van Vlaanderen heeft in de jaren '70 $\&$ '80 winst gemaakt met het maken van de btere tapijten. Tot begin jaren 2000 was er geen enkel probleem: heel mooie marges. Ineens kwam er druk op de marges, voornamelijk omdat er vanuit de lageloonlanden concurrentie opkwam. Men begon zich af te vragen wat te doen.
Slide 34 (met grafieken, niet in gegeen slides): marges zaten goed, maar in 2005: aan de rechterkant: EBITDA: behoorlijke duik in 2005.
Slide 35: 5 forces van Porter: 
	1. Mensen die u grondstoffen leveren: verhouding tussen jij als industrie vs mensen die u grondstoffen leveren. De grondstofprijzen gingen omhoog. Als je olieprijs omhoog gaat, gaan de kosten om tapijten te maken ook omhoog.
	2. Kijk naar mensen die in de industrie komen: is op zich niet moeilijk: je hebt grondstoffen nodig, je kan garen gewoon kopen, je hebt standaardmachines nodig en mensen. Mensen vind je ook ewl overal. Het is dus niet zo moeilijk om in die markt binnen te dringen en je kan dat goedkoper doen want je hebt de laatste nieuwe machine die sneller kan werken en je gaat lage loonkosten hebben.
	3. Binnen de industrie: hoeveel competitie is daar? Bij tapijten is er heel veel competitie want iedereen maakt ongeveer hetzelfde tapijt, biedt ongeveer hetzelfde aan. Om te zrogen dat jij als klant eerder een tapijt koopt van Balta dan van iemand anders, dat is heel moeilijk, aangezie het geen merk is. Het is heel moeilijk om te differentieren.
	4. Zijn er andere producten die tapijt kunnen substitueren? N 2004 was dat vrij neutraal, toen was er vrij veel vraag. Nu is dat redelijk rood aan het kleuren, mensen hebben liever parket, steen,… --> het is iets dat nu gevoelieger ligt.
	5. Klanten: hoeveel macht hebben ze? Heel veel van de bedrijven zijn carpet right,… --> hebben veel macht. De persoon die de tapijten maakt wordt dus vrij snel negatief beinvloed.
Nieuwe spelers kwamen binnen, olieprijzen gingen omhoog, klanten hadden veel macht. Balta wou dus kijken wat mogelijkw as: in Vlaanderen vrij arbeidsintensief.
Slide 36: kijken wat kan: initieel maar 2 dingen mogelijk: tunesie of turkije. 
Slide 37: aantal concrete vragen beantwoorden:
	• Gaat het ons competitief iets bijbrengen? 
Slide 38: linkerkant: kost om een bepaald type tapijt te maken bij Balta in Belgie. Je ziet een groot stuk de materials, dan labour en andere kosten. De concurrenten zijn hand-tufted tapijten in lageloonlanden: hoewel acrylic duurder is, zijnd e mensen goedkoper --> goedkoper dan hier in belgie gemaakt. Met de hand gemaakt: "zal wel beter zijn" --> heel makkelijk om het klassieke polypropyleentapijt onderuit te halen. Je kan de gemiddelde klant in belgie heel makkelijk wijsmaken dat het hand-tufted beter is, en daar wordt meer winst op gemaakt voor de verkoper, dus klanten zullen die meer kopen. Op zich is die niet beter, gewoon goedkoper en de retailer wordt er rijker van. Er werd dan gezegd van die productie naar een lageloonland te brengen --> leverkost gaat naar beneden en je hebt logistieke problemen want tapijten zijn niet zomaar te vervoeren, maar het zal toch goedkoper zijn.
Financieel leek dit dus te werken: stap in de goede richting. Een andere vraag is of het gaat helpen met uw echt probleem: je bent duurder dan uw concurrent.
Puur operationele element: belangrijk als bedrijf te bedrijpen wat de zaken zijn die belangrijk zijn. 
Slide 39: als je kijkt naar wat die zaken waren, 
	• procurement: producten aankopen en een grote speler heeft meer invloed dan een kleine. Het voordeel dat je hebt vanuw fabriek ergens anders te zetten, speel je dat kwijt? Het voordeel van groot te zijn voor een aankoop blijf je behouden.
	• Productie en de kwaliteit: hoogwaardige productie: gaan we die kwaliteit kunnen halen? De nodige mensen met know-how oversturen zdd die hoogwaardige productie ook in die landen blijft gebeuren. 
	• Procestechnologie: voor het make n van de vezel: ze kopen polyprop aan in kleine pastilles en dat wordt gesmolten en gepsonenne n daar worden lange draden van gemaakt. Vrij high-tech, maar ookd at stuk van de productie wou men in belgie halen, du sging niks veranderen.
	• Logistiek: behoorlijke kunst om tapijten in europa te kunnen versturen: meeste schrik van: gaan we dat voordeel nu kunnen behouden?
	• Product design: gaat niks aan veranderen
	• Verkoopsmechanisme: gaat niks aan veranderen.
Dus productie en schaalvoordelen, daarbij was men comfortabel.
Men is enkel het stuk vn exclusie, het maken van de fibers in belgie houden.
Slide 40: totale kostenstructuur voor he tmaken van de producten.
	• Extrusie: eetste stap
	• Weven, afwerken, knippen,…
Wat je ziet is dat het eerste punt de grootste kost is. Qua labor kost is het heel laag en het is ee behoorlijk technologisch iets en iets wat hen heel na aan het hart ligt. Er is dus gezegd dat men dat wou houden in belgie. De rest wel mag verhuisd worden. Het is in lijn met de strategie en operationeel.
Slide 41: Naar waar? Approach: filtersysteem: je kan overal naartoe: minder en minder landen overhouden en in detail berekenen wat het beste is.
Slide 42: eerste: structurele vragen: risico. Er zijn landen waar het iets meer risico is om business te doen dan anderen. Er bestaan een hoop organisaties met dit in te plannen. Een aantal vna die plaatsen zijn onedertussen veranderd. Er viel er eentje echt uit: Indonesie en Egypte (probeelm hiermee: 1 grote concurrent van Balta. Is op zich niet slecht, maar was half eigendom van de staat/leiders van dat land --> eigen fabriek zetten bij concurrent in een land waar ze mogen beslissen om de weg voor uw deur dicht te doen ==> Veel te veel risicos om vast te lopen)
Slide 43: Loonkosten --> huidige loonkost en hoeveel gaat die stijgen? Niet enkel de verhuis nu, maar ook binenn een jaar, paar jaar. Veel van die oost-europese landen zitten met de huidige kost maar ook de groei die voorzien is, is redelijk hoog. Landen als polen, slowakije,…. Zijn stukken goedkoper, maar je weet dat dat op termijn ingehaald gaat worden. 
Slide 44: Logistieke kost: Hoeveel gaan uw labour svings zijn, en wat zijn uw logistieke kosten? China komt er plots minder goed uit: lonen zijn niet zo verschillend, logistieke kosten wel verschillend: kost veel om producten naar hier te rkijgen.
Slide 45: nog maar een paas opties over (gele landen) --> hoe logistiek doen? Als je in turkije produceert: alles in camion steken en dan naar hier verhuizen, als boot nodig is, dan overzetten naar camion,…  --> veel werk. Voor al die landen kijken wat al dan niet realistisch is.
Slide 46: Uiteindelijk ga je voor de verschillende landen die overbijven een soort van totale screening doen. Begin met uw risicoanalyse. Kijk of je de juiste labour hebt: juiste mensen met de juiste skills --> vaak bewegen mensen in clusters naar een bepaalde regio. Turkije heeft een traditie in het maken van tapijten, dus je gaat mensen hebben met de juiste skills. Tunesie heeft heel wat mesnen met skills in textiel, maar niet in tapijten.
Machines onderhouden: als daar iets mee misloop ten je moet mensen uit belgie gaan halen om die te herstellen, voordeel van een land als turkije: genoeg machines en genoeg mensen om de machines te onderhouden. Je moet dus kijken wat de kost is om mensen te vinden en ook wat he tkost om de machines te onderhouden.
IP: intellecutal property: desgin van uw tapijt (je wil niet dat de concurrenten dezelfde designs hebben). Men had wel wat schrik want er was wel wat concurrentie: geen garantie dat uw geheiemn niet gaan lekken. Dit was een van de redenen dat men oorspronkelijk nietnaar China wou. 
Business klmaat: is het eeen land waar het positief is om een bedrijf te starten? Is er het gevoel van als men daar start, of men geboycot of geholpen gaat worden? Tunesie: vrij actief: free trade: plaatsen waar je bedrijvne kan starten en dan krijg je voordelen qua energie etc.
Kostenstructuur $\&$ labour kost, tax $\&$ tax savings. Heel belangrijk hier is niet enkel uw logistieke kost, maar ook exportkosten van land naar land. Dit hangt af van product tot product en van land tot land. Je moet dus heel goed weten dat als je eergens iets maakt, wat de verschillende taxen zijn. 
Mean time vanuw logistiek: hoe lang duurt het om van het ene naar het andere te gaan?
Kennen we het land: het feit dat je al in het land gewerkt hebt en je daar mensen kent die u wegwijs kunnen maken is ook belangrijk. De stad waarin je dat doet moet ook akkoord gaan etc. als je er mensen kent, is dat duidelijk een voordeel.
Men kwam tot de conclusie dat Turkije en Tunesie vooroplagen. 
Slide 47: Daarna ga je de gedetailleerde berekening maken van wat het u gaat kosten en opbrengen. Hoeveel capex (cash) moet je er gaan insteken? Hoeveel cash nodig om te verhuizen, om de productie een zekere tijd stil te leggen,… je gaat tapijten op stock moeten zetten teijdens de verhuis.
Wat is de operationele kost, hoeveel goedkoper gaat het zijn daar vs hier. Dan kijken wat het totale cashplan is en of het past in wat kan en amg.
As je dit soort verhuizen doet: hele vraag van hoe je dit gaat doen: 10 weefgetouwen per jaar verhuizen, meer/minder,… --> hoe sneller :hoe sneller je voordeel gaat hebben.
Slide 49: In functie vna de verschilllen in payback.
