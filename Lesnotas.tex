...
Slides: 8\_Bedrijfskunde\_Budgettering en kasplanning

Slide 1: Bedrijven moeten altijd een plan met budgetten voor de komende 5j voorleggen om aan te tonen dat ze kunnen blijven bestaan, dat ze voldoende cash flow zullen kunnen genereren om te kunnen blijven bestaan.
Slide 3: Elk bedrijf gaat een strategische planningscyclus hebben waarbij men bv werkt met een tijdshorizon van bv 5j waarbij men alle kosten zal vastleggen en ieder jaar schuift men een jaar verder door. Op het eind van het jaar gaat men analyseren wat er evt anders gelopen is dan voorzien en waarom. Iedere keer dus een raming maken van inkomsten en uitgaven. Je gaat van alles inkomsten en uitgaven proberen te schatten en dit achteraf bekijken. Je moet dus kijken naar de liquiditeit en solvabiliteit (kunnen we de leningen, lonen,… betalen?).
Slide 5: Jemoet kunnen plannen en de zaken kaderen binnen de doelstellingen van het bedrijf. Je moet gaan organiseren (kan gekoppeld zijn aan deproducten of aan de markten), mensen gaan motiveren en achteraf zelf controleren  en nagaan hoe alle middelen zijn toegepast.
Slide 6: Gewone begroting: elk jaar budget opstellen voor de komende 5j. Investeringsbudgetten zijn eerder buitengewone begrotingen. 
Slide 7: Dit is wat we willen weten: wat is onze winst en wat is onze opbrengst en wat zijn onze kosten? Het is niet zeker dat dit het eindresultaat zal zijn, vandaar dus "(geplande)".
...
Seizoenmatigheid: soms heb je pieken in de verkoop. 
Bederfbaarheid: voorraadrotatie zo maken dat uw producten buiten zijn voor ze bedorven zijn.
Voorraadkosten: sommige producten moeten op speciale manieren bewaard worden (gekoeld, verwarmd,…).
Aankoopbeleid: kunnen we bepaalde batches aankopen en hoe groot moeten/mogen die dan zijn?
Slide 10: Investeringsbudget: als je merkt dat uw capaciteit onvoldoende is om aan de vraag te voldoen, moet je investeren in nieuwe machines/mensen/… 
Slide 11: Het is nodig te weten wanneer er tekorten/overschotten zijn, of sommige zaken verschoven kunnen worden, welke leningen aangegaan kunnen worden,… ==> previsionele resultatenrekening en balans.
Slide 13: Voorbeeld: de meeste van die getallen zijn daar gewoon geplaatst (probeer ze dus niet zelf te berekenen!). Er worden soms ook afrondingen gemaakt, dus geen exacte berekeningen. Het is de bedoeling dat we proberen om zo'n tabel op te stellen. 
Slide 14: Bedrijf verkoopt product X $\&$ Y, met 3 markten. Via marketingstudies checken we wat de verkopen zouden kunnen zijn in het volgende jaar (dus enkel 1 jaar bekijken, geen reeks jaren). De verkoopsaantallen zijn te zien in de onderste rij an de tabel (in kolommen van "Eenheden"). 210 000 * 100 = 21 000 *(maal $10^{3}$, zie bovenaan). We gaan kijken hoe het zit met onze voorraaden. Dit zien we in de Begininventaris van de tweede tabel. Je ziet dat je niet 1 000 000 stuks gaat produceren, maar 960 000. Dit is afhankelijk van de situatie (o.a. waar in de cyclus je zit).
Slide 15: O.b.v. daarvan kunnen we zien wat de voorraadwaarde is en de waarde per stuk (168 en 69). Een product is meestal samengesteld uit deelproducten. We gaan nog MRP (Material Requirement Planning) zien. Product X wordt samengesteld uit A, B en C: dit is de productstructuur (zie tekening).
...
Slide 16: O.b.v. de voorgaande berekeningen kunnen we gaan zien hoeveel stuks we moeten gaan produceren.
...
Slide 17: rekening houdend met de beginvoorraad en de gewenste eindvoorraad krijg je de tabel. 
Slide 18: Directe loonkosten de gelinkt zijn aan de productie. 
Slide 19: Indirecte kosten: de cijfers zijn ter illustratie, niet ergens berekend. Wij zijn geïnteresseerd in de 39 939 onderaan.
Slide 20: De kostprijs die we mogen aanrekenen is kleiner dan onze aankoopprijs (70 830 vs 70 950), dit komt omdat we met voorraden zitten, we mogen die niet zomaar doorrekenen.
Slide 23: Alles samenbrengen: previsionele resultatenrekening. 
Slide 24: Uiteindelijk zal het zo zijn, obv onze productie en eht feit dat het productiepark verouderd, dat we een investeringsbudget moeten samenstellen. Sommige zaken zullen over verschillende jaren lopen, je moet dat proberen opsplitsen. 
Slide 27: Een budget moet opgesteld worden en je meot dit achteraf gaan controleren op verschillende facetten. Je moet ervoor zorgen dat iedereen op de hoogte is van de budgetten. Het is niet omdat iemand iets aanvraagt, dat hij/zij dat budget ook altijd krijgt, die moet zijn/haar budget eventueel ook gaan aanpassen aan wat toegewezen wordt. 
Slide 29: Interpretatie van een aantal zaken.
Slide 30: We gaan kijken naar de afwijking van het gebudgetteerde bedrag en de werkelijkheid. Je gebruikt bijd e werkelijke productie ook 1875 omdat dat het aantal is dat je werkelijk geproduceerd hebt, maar je moet wel gaan kijken naar uw voorspelde waarden (standaard materiaalverbruik en gebudgetteerde materiaalprijs). Het materiaalverbruik en de materiaalkost bleek hoger dan voorspeld. 
Slide 32: 180 000 komt van 1875 * 96. 196 875 komt van 1875 * 105. Als we efficiënt waren geweest, had het prijsverschil even breed geweest als "budget bij standaardverbruik", maar nu is dat dus "budget bij standaardverbruik" + "efficiëntieverschil).
Slide 33: 
...
Slide 34: Berekeningen bij de grafiek. Het efficiëntieverschil is puur afkomstig van variabele kosten (denk ik).
...
Slide 3: Als we investeren in een nieuwe productie-eenheid (bv fabriek), moeten we gaan nagaan waar het interessant is om te gaan investeren. 
...
Slide 5: 
	• Vervangingsprobleem: het systeem is fysisch verouderd (werkt bv niet meer). 
	• Moderniseringsprobleem: machine kan niet meer mee
	• Expansieprobleem: meestal wnr je een nieuw product op de markt brengt en de markt groeit of met dalende marktvraag omgaan.
	• Strategisch probleem: nieuwe eenheden plaatsen op nieuwe locaties.
Slide 6: 
	• Fysische levensduur: verouderde machines
	• Economische levensduur: als uw product goedkoper gemaakt kan worden
	• Productlevensduur: als uw product na 3j verouderd is, ga je niet voor 10j investeren in dat product, maar maar voor 3j.
	• Fiscale levensduur: afschrijvingen
Als je projecten gaat vergelijken met elkaar, moeten dat gelijkwaardige projecten zijn (project dat 2j duur vs project dat 5j duurt). 
Uitgavepatroon: alle investeringsonkosten moeten daarin gerekend worden. Je moet kijken naar alle kosten zdd uw installatie kan werken.
Slide 7: kasstroom: inkomsten en uitgaven per periode (kunnen variëren per periode), we krijgen dan de bruto kasstroom. Daarvan gaan we de afschrijvingen aftrekken, krijgen we de belastbare winst, waarvan we de belastingen moeten betalen, waarop we de winst na belastingen krijgen. Daarna tellen we er de afschrijvingen opnieuw bij op (soort recuperatie die je mag doen door minder belastingen te doen. Je moet die afschrijvingen niet nog eens betalen wnt dan zou je 2x betalen). Als je afschrijvingen ziet als kasstromen op het examen, ben je gebuisd voor die vraag op het examen. 
Slide 8: Belangrijk te juiste kosten te kennen. Kern van de zaak is dat je alles wilt omzetten in geld.
Slide 9: 
	• Samengestelde interesten: veronderstel dat we ergens een bepaald kapitaal p hebben dat we beleggen. Als we dat beleggen aan een bepaalde interest, wil dat zeggen dat na 1 periode het kapitaal gelijk is aan P + Pi. Als je dat bedrag dan opnieuw belegt, dan zal P vermenigvuldigd worden met i, maar uw interest ook. Het kapitaal waarmee we startten zal dus gelijk zijn aan F = P(1+i)n als je alles hebt laten staan.
Slide 10: Bij hoge interestvoeten zie je dat je niet lineair mag denken, bij kleine interestvoeten zal de geschatte en de werkelijke opbrengst ongeveer gelijklopen.
Slide 11: De meest linkse kolom is het aantal periodes. Bovenaan vind je dan telkens het aantal percentages terug. Je ziet dan na hoeveel periodes je hoeveel zal hebben.
Slide 13: we gaan normaal alles proberen terugbrengen naar het "nu"-moment: naar de waarden die nu geldig zijn. Daarom spreken we over actualisatie. 
Slide 15 $\&$ 16: huidige waarde van 1 euro. Let op dat er gesproken is over periodes en niet over jaren. Het kan zijnd at men over trimesters spreekt en niet over jaren.
Slide 17: We zullen niet 1 bedrag hebben dat binnenkomt, maar zal verspreid zijn voer de horizon. Kunnen uiteraard ook negatieve waarden zijn. Je moet uiteindelijk altijd vergelijken met het nulmoment.
Slide 18: We kunnen de gegeven vraag gaan berekenen:
...
Slide 21: Banklening van 100 000 en je hebt een trimesteriële rentevoet van 4%. De terugbetalingen gebeuren altijd op een specifiek moment. We hebben n = 5 en I = 4%. Kijken we in onze tabel op Slide 19 (rij 5, kolom van 4%), krijgen we: A*4,4518 = 100 000 => A = 22 463.
Hoe wordt dat nu allemaal uitgesplitst? 
